...
public class AutoScaleThenSwitchFromRight extends Autonomous {
	...
	//Paths
	private Path startToScaleLeft = new StartRightToSwitchLeft();
	private Path startToScaleRight = new StartRightToSwitchRight();
