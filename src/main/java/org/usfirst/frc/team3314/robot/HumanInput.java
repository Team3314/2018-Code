...
public class HumanInput {
	...
	public boolean getEngagePTO() {
		return gamepad.getRawButton(8) && gamepad.getRawButton(7) || leftStick.getRawButton(8) && leftStick.getRawButton(7);
	}
	public boolean disengagePTO() {
		return rightStick.getRawButton(7) && rightStick.getRawButton(8);
	}
	...
	public boolean getIntakeSlowPressed() {
	...
	public boolean getRampRelease() {
		return (gamepad.getPOV() == 180 && gamepad.getRawButton(10)) || (leftStick.getRawButton(12) && leftStick.getRawButton(11));
	}
	public boolean getRampClose() {
		return rightStick.getRawButton(11) && rightStick.getRawButton(12);
	}
